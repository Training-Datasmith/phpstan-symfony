...
final class Argument_Type_Specifying_Extension implements Method_Type_Specifying_Extension, Type_Specifier_Aware_Extension
{
    ...
    {
        return $method_reflection->get_name() === 'hasArgument' && !$context->null();
    }
